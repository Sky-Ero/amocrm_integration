...
class Pipeline extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'is_main', 'sort', 'responsible_user_id', 'created_by', 'updated_by', 'created_at', 'updated_at', 'closest_task_at', 'ltv', 'is_deleted', 'purchases_count', 'average_check', 'account_id', 'catalog_elements', 'companies', 'tags', 'segments'];
}
